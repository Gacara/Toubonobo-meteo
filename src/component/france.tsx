...
export default function FranceMap({selectedCity}: franceInterface): React.ReactElement{
    const paris = "paris";
    const annecy = "annecy";
    const lyon = "lyon";
...
<g>
   <path onMouseEnter={() => setCityOnHover(paris)} fill={getColor(paris)} d="M503.3,105.4l-5,3.9l-3.1,0.1l-5.8-2.6l-4-3.3h-7.7l-1.4,3.1l-6.3,0.8l-3.9-8.1l-3.5,0.3v-3.5l-6.8-1.7
   ...
   <path fill="#FBFAF9" d="M178.5,114l-6,2.6l-7.2-11.8l2.8-8.8l-1.2-3.1l-7.3-0.8l-2.8,2l-7.3,0.5l-12.8-5.2l-0.2,3.2l3.7,2l0.6,5.5
